...
Source0  : https://files.pythonhosted.org/packages/42/c2/decb25538588ed104ada22c31d1845b1500f98806e3261b94f0333e8b099/jupyterlab-4.1.6.tar.gz
...
%prep
%setup -q -n jupyterlab-4.1.6
cd %{_builddir}/jupyterlab-4.1.6
pushd ..
cp -a jupyterlab-4.1.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712611231
